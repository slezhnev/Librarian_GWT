...
import ru.lsv.gwtlib.server.library.LibraryUtils;
...
public class FB2BookParser extends DefaultHandler {
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (qName.equalsIgnoreCase("title-info")) {
			...
			if (tempBook != null) {
				...
				try {
					tempBook.setNumInSerie(Integer.parseInt(attributes
							.getValue("number")));
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (qName.equalsIgnoreCase("title-info")) {
			...
			if (tempAuthor != null)
				tempAuthor.setFirstName(tempVal);
		} else if (qName.equalsIgnoreCase("middle-name")) {
			if (tempAuthor != null)
				tempAuthor.setMiddleName(tempVal);
		} else if (qName.equalsIgnoreCase("last-name")) {
			if (tempAuthor != null)
				tempAuthor.setLastName(tempVal);
		} else if (qName.equalsIgnoreCase("author")) {
			if (tempBook != null) {
			...
			if (tempBook != null)
				tempBook.setLanguage(tempVal);
		} else if (qName.equalsIgnoreCase("src-lang")) {
			if (tempBook != null)
				tempBook.setSourceLanguage(tempVal);
		} else if (qName.equalsIgnoreCase("annotation")) {
			if (tempBook != null)
				tempBook.setAnnotation(tempVal);
		}
